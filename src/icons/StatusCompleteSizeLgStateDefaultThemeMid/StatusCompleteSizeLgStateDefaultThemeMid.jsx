...
export const StatusCompleteSizeLgStateDefaultThemeMid = ({ color = "#F9F5FF", className }) => {
  return (
    <svg
      className={`status-complete-size-lg-state-default-theme-mid ${className}`}
      fill="none"
      height="40"
      viewBox="0 0 40 40"
      width="40"
    ...
    >
      <g className="g" clipPath="url(#clip0_126_247)">
        ...
        <path
          ...
          fillRule="evenodd"
        />
        <rect className="rect" height="38" rx="19" stroke="#7F56D9" strokeWidth="2" width="38" x="1" y="1" />
      </g>
      <defs className="defs">
        <clipPath className="clip-path" id="clip0_126_247">
...
StatusCompleteSizeLgStateDefaultThemeMid.propTypes = {
