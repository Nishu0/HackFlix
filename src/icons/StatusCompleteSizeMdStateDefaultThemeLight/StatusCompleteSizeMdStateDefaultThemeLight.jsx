...
export const StatusCompleteSizeMdStateDefaultThemeLight = ({ color = "#F9F5FF", fill = "#7F56D9", className }) => {
  return (
    <svg
      className={`status-complete-size-md-state-default-theme-light ${className}`}
      fill="none"
      height="32"
      viewBox="0 0 32 32"
      width="32"
    ...
    >
      <g className="g" clipPath="url(#clip0_126_226)">
      ...
      <defs className="defs">
        <clipPath className="clip-path" id="clip0_126_226">
...
StatusCompleteSizeMdStateDefaultThemeLight.propTypes = {
