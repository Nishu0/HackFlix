...
export const StatusCompleteSizeSmStateFocusedThemeDark = ({ color = "#7F56D9", fill = "white", className }) => {
  return (
    <svg
      className={`status-complete-size-sm-state-focused-theme-dark ${className}`}
      fill="none"
      height="24"
      viewBox="0 0 24 24"
      width="24"
    ...
    >
      <g className="g" clipPath="url(#clip0_126_205)">
      ...
      <defs className="defs">
        <clipPath className="clip-path" id="clip0_126_205">
...
StatusCompleteSizeSmStateFocusedThemeDark.propTypes = {
